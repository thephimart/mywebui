...
class Document(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    owner_id: Mapped[uuid.UUID] = mapped_column(String(36), ForeignKey("users.id"), nullable=False)
...
class Chunk(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    document_id: Mapped[uuid.UUID] = mapped_column(String(36), ForeignKey("documents.id"), nullable=False)
...
class Embedding(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    chunk_id: Mapped[uuid.UUID] = mapped_column(String(36), ForeignKey("chunks.id"), nullable=False)
...
class AuditEvent(Base):
    ...
    user_id: Mapped[uuid.UUID] = mapped_column(String(36), ForeignKey("users.id"), nullable=True)
